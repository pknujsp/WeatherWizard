...
package io.github.pknujsp.weatherwizard.core.ads.nativetemplates;
...
import io.github.pknujsp.weatherwizard.core.ads.R;
...
public class TemplateView extends FrameLayout {
	...
	public String getTemplateTypeName() {
		if (templateType == io.github.pknujsp.weatherwizard.core.ads.R.layout.gnt_medium_template_view) {
			return MEDIUM_TEMPLATE;
		} else if (templateType == io.github.pknujsp.weatherwizard.core.ads.R.layout.gnt_small_template_view) {
	...
	private void initView(Context context, AttributeSet attributeSet) {
		...
		TypedArray attributes = context.getTheme().obtainStyledAttributes(attributeSet, io.github.pknujsp.weatherwizard.core.resource.R.styleable.TemplateView, 0, 0);

		try {
			templateType = attributes.getResourceId(io.github.pknujsp.weatherwizard.core.resource.R.styleable.TemplateView_gnt_template_type, R.layout.gnt_medium_template_view);
		} finally {
			attributes.recycle();
		}
