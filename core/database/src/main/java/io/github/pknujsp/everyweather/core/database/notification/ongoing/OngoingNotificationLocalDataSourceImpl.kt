...
class OngoingNotificationLocalDataSourceImpl
    @Inject
    constructor(
        ...
        override suspend fun updateOngoingNotification(notificationDto: NotificationDto): Boolean =
            notificationDao.insert(notificationDto) >= 0
