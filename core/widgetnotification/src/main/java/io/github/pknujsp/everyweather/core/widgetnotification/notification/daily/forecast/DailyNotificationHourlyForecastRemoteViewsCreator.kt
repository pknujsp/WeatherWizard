...
class DailyNotificationHourlyForecastRemoteViewsCreator :
    ...
    override fun createSmallContentView(
        ...
        val contentView =
            RemoteViews(context.packageName, R.layout.notification_daily_forecast_small).apply {
        ...
        val hourlyForecast =
            MockDataGenerator.fakeHourlyForecastEntity.run {
                items.subList(hourRange.first, hourRange.last).map { item ->
                    ...
                    DailyNotificationForecastRemoteViewUiModel.HourlyForecast(
                        temperature =
                            item.temperature.convertUnit(units.temperatureUnit)
                                .toString(),
                        weatherIcon = item.weatherCondition.value.dayWeatherIcon,
    ...
    override fun createBigContentView(
        ...
        val contentView =
            RemoteViews(context.packageName, R.layout.notification_daily_forecast_big).apply {
