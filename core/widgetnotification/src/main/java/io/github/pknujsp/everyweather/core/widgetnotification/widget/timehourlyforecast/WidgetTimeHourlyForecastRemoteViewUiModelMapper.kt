...
class WidgetTimeHourlyForecastRemoteViewUiModelMapper :
    ...
    override fun mapToUiModel(
        ...
        return model.let {
            ...
            val currentWeather =
                primaryEntity.toEntity<CurrentWeatherEntity>().run {
            ...
            val hourlyForecast =
                primaryEntity.toEntity<HourlyForecastEntity>().run {
                        ...
                        WidgetTimeHourlyForecastRemoteViewUiModel.HourlyForecast(
                            ...
                            weatherIcon =
                                item.weatherCondition.value.getWeatherIconByTimeOfDay(
                                    dayNightCalculator.calculate(time.toCalendar()) == DayNightCalculator.DayNight.DAY,
                                ),
