...
sealed interface ComponentServiceAction<T : ComponentServiceArgument> {
    ...
    companion object {
        ...
        private fun <T : ComponentServiceArgument> KClass<T>.toArgument(
            get: (String) -> Any,
        ...
        private fun <T : ComponentServiceArgument> Bundle.toArgument(argumentClass: KClass<T>): T =
        ...
        fun toInstance(map: Map<String, Any>): ComponentServiceAction<out ComponentServiceArgument> =
            map[KEY]!!.let {
                ...
                when (it) {
                    ...
                    DailyNotificationServiceArgument::class.simpleName ->
                        DailyNotification(
                            map.toArgument(DailyNotificationServiceArgument::class),
                        )
                    OngoingNotificationServiceArgument::class.simpleName ->
                        OngoingNotification(
                            map.toArgument(
        ...
        fun toInstance(bundle: Bundle): ComponentServiceAction<out ComponentServiceArgument> =
            bundle.getString(KEY)!!.let {
                when (it) {
                    ...
                    DailyNotificationServiceArgument::class.simpleName ->
                        DailyNotification(
                            bundle.toArgument(DailyNotificationServiceArgument::class),
                        )
                    OngoingNotificationServiceArgument::class.simpleName ->
                        OngoingNotification(
                            bundle.toArgument(
