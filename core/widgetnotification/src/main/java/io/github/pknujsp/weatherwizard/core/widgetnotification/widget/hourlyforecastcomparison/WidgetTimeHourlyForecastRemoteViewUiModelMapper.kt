...
class WidgetTimeHourlyForecastRemoteViewUiModelMapper :
    ...
    override fun mapToUiModel(model: SavedWidgetContentState.Success, units: CurrentUnits): WidgetHourlyForecastComparisonRemoteViewUiModel {
        return model.let {
            ...
            WidgetHourlyForecastComparisonRemoteViewUiModel(currentWeather, hourlyForecast)
        }
    }
