...
class OngoingNotificationRemoteViewsCreator : NotificationRemoteViewsCreator<OngoingNotificationRemoteViewUiModel>() {
    override fun createSampleView(
        ...
        val contentView =
            RemoteViews(context.packageName, R.layout.notification_ongoing_small).apply {
    ...
    override fun createSmallContentView(
        model: OngoingNotificationRemoteViewUiModel,
        header: Header,
        context: Context,
    ): RemoteViews {
        val contentView =
    ...
    override fun createBigContentView(
        ...
        val contentView =
            RemoteViews(context.packageName, R.layout.notification_ongoing_big).apply {
                model.apply {
                    setImageViewResource(R.id.weather_icon, currentWeather.weatherIcon)
                    setTextViewText(R.id.temperature, currentWeather.temperature)
                    setTextViewText(R.id.feels_like_temperature, currentWeather.feelsLikeTemperature)
