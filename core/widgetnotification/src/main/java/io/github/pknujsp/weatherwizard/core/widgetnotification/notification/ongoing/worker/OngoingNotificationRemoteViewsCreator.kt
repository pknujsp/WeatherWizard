...
class OngoingNotificationRemoteViewsCreator : io.github.pknujsp.weatherwizard.core.widgetnotification.notification.remoteview.NotificationRemoteViewsCreator<OngoingNotificationRemoteViewUiModel>() {
    override fun createSampleView(context: Context, units: CurrentUnits): RemoteViews {
        ...
        return createBaseView(context, io.github.pknujsp.weatherwizard.core.widgetnotification.remoteview.RemoteViewCreator.ContainerType.NOTIFICATION_SMALL).apply {
    ...
    override fun createBigContentView(model: OngoingNotificationRemoteViewUiModel, header: Header, context: Context): RemoteViews {
        ...
        return createBaseView(context, io.github.pknujsp.weatherwizard.core.widgetnotification.remoteview.RemoteViewCreator.ContainerType.NOTIFICATION_BIG).apply {
            createHeaderView(this, header)
            addView(R.id.remote_views_content_container, contentView)
        }
    }
