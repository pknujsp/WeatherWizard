...
class WidgetDailyForecastComparisonRemoteViewCreator : WidgetRemoteViewsCreator<WidgetDailyForecastComparisonRemoteViewUiModel>() {
    override fun createContentView(
        model: WidgetDailyForecastComparisonRemoteViewUiModel,
        header: Header,
        context: Context,
    ): RemoteViews {
                    ...
                    containerView.addView(
                        ...
                        RemoteViews(context.packageName, R.layout.view_daily_forecast_item).apply {
                            ...
                            it.weatherIcons.forEach { icon ->
                                addView(
                                    R.id.weather_icons,
                                    RemoteViews(context.packageName, R.layout.view_weather_icon_item).also { iconView ->
    ...
    private fun RemoteViews.applyDailyForecastItem(
        date: String,
        temperature: String,
    ) {
