...
object AppButtonDefaults {
    @Composable
    fun primary(buttonSize: BaseButtonSize = ButtonSize.MEDIUM) =
        AppButton(
    ...
    @Composable
    fun secondary(buttonSize: BaseButtonSize = ButtonSize.MEDIUM) =
        AppButton(
    ...
    @Composable
    fun third(buttonSize: BaseButtonSize = ButtonSize.MEDIUM) =
        AppButton(
...
enum class ButtonSize(override val paddingValues: PaddingValues, override val fontSize: TextUnit) : BaseButtonSize {
    SMALL(PaddingValues(horizontal = 16.dp, vertical = 8.dp), 14.sp),
    MEDIUM(PaddingValues(horizontal = 24.dp, vertical = 12.dp), 15.sp),
