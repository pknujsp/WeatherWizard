...
enum class WidgetType(val categories: Array<MajorWeatherEntityType>) : IEnum {
    TIME_HOURLY_FORECAST(arrayOf(MajorWeatherEntityType.CURRENT_CONDITION, MajorWeatherEntityType.HOURLY_FORECAST)) {
        ...
        override val title: Int = io.github.pknujsp.everyweather.core.resource.R.string.time_hourly_forecast_widget
    ...
    HOURLY_FORECAST_COMPARISON(arrayOf(MajorWeatherEntityType.CURRENT_CONDITION, MajorWeatherEntityType.HOURLY_FORECAST)) {
        override val icon: Int? = null
        override val key: Int = ordinal
        override val title: Int = io.github.pknujsp.everyweather.core.resource.R.string.hourly_forecast_comparison_widget
    },
    DAILY_FORECAST_COMPARISON(arrayOf(MajorWeatherEntityType.DAILY_FORECAST)) {
        override val icon: Int? = null
        override val key: Int = ordinal
        override val title: Int = io.github.pknujsp.everyweather.core.resource.R.string.daily_forecast_comparison_widget
    },
    ALL_IN_ONE(
        arrayOf(
        ...
        override val icon: Int? = null
        override val key: Int = ordinal
        override val title: Int = io.github.pknujsp.everyweather.core.resource.R.string.all_in_one_widget
    }, ;
