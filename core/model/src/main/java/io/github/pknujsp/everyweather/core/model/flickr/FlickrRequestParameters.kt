...
data class FlickrRequestParameters(
    ...
    fun toGetPhotosFromGalleryParameter(): FlickrGetPhotosFromGalleryParameter {
        ...
        currentCalendar.set(
            lastRefreshDateTime.year,
            lastRefreshDateTime.monthValue - 1,
            lastRefreshDateTime.dayOfMonth,
            lastRefreshDateTime.hour,
            lastRefreshDateTime.minute,
    ...
    fun toGetInfoParameter(
        photoId: String,
        secret: String,
    ): FlickrGetInfoParameter {
