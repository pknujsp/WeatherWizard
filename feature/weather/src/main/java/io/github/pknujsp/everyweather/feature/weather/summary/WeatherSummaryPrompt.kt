...
class WeatherSummaryPrompt(
    ...
    - **오늘의 시간별 예보 요약**: "오늘 오전에는 기온이 OO도까지 올라갈 것으로 예상되며, 오후에는 OO도에 이를 것입니다. 강수 확률은 오전 OO%에서 오후에는 OO%로, 오후에 비가 올 가능성이 더 높습니다. 바람은 하루 종일 OOm/s로 불 것이며, 특히 오후에는 바람이 강해질 수 있습니다."
