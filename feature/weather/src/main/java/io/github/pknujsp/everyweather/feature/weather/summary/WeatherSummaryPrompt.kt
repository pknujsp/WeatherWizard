...
class WeatherSummaryPrompt(
    ...
    출력 지시사항 (텍스트 형식으로 개선, 경우에 따라 다른 정보를 포함할 수 있음):
    ## **날짜 및 시간**: "안녕하세요, 오늘은 YYYY년 MM월 DD일입니다."
    
    ## **현재 날씨 상태**: "지금 기온은 OO도이며, 체감 온도는 OO도로 느껴집니다. 습도는 OO%이고, 바람은 OOm/s의 속도로 OO 방향에서 불고 있습니다. 오늘은 강수량이 OOmm 예상되니, 우산을 준비하시는 것이 좋겠습니다."
    
    ## **오늘의 시간별 예보 요약**: "오늘 오전에는 기온이 OO도까지 올라갈 것으로 예상되며, 오후에는 OO도에 이를 것입니다. 강수 확률은 오전 OO%에서 오후에는 OO%로, 오후에 비가 올 가능성이 더 높습니다. 바람은 하루 종일 
    OOm/s로 불 것이며, 특히 오후에는 바람이 강해질 수 있습니다."
    
    ## **이번 주 날씨 전망**: "이번 주는 대체로 OO한 날씨가 이어질 예정입니다. 특히, XX요일에는 최고 기온이 OO도까지 오르며, YY요일에는 최저 기온이 OO도로 내려갈 수 있으니, 온도 변화에 주의해 주세요. 주말에는 OO 날씨가 예상되니, 야외 활동 계획에 참고하시기 바랍니다."
    
    ## **대기질 상태 및 조언**: "현재 대기질 지수는 OO로, 'OO' 상태입니다. 오늘은 특히 호흡기가 민감한 분들이 외출 시 마스크를 착용하시는 것이 좋겠습니다. 야외 활동을 계획하시는 분들은 대기질 변화를 주시하며, 필요한 조치를 취해 주세요."
