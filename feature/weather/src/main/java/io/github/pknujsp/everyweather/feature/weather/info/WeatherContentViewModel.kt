...
class WeatherContentViewModel
    ...
    constructor(
        ...
        private val targetLocation =
            mutableTargetLocations.combine(settingsRepository.settings) { location, settings ->
                ...
                viewModelScope.launch {
                    val newState =
                        withContext(dispatcher) {
                            ...
                            val entity =
                                when (val result = getWeatherDataUseCase(request.first(), false)) {
                            ...
                            val dayNightCalculator =
                                DayNightCalculator(coordinate.latitude, coordinate.longitude, requestDateTime.toTimeZone())
                            ...
                            val yesterdayWeather =
                                if (entity.weatherDataMajorCategories.contains(MajorWeatherEntityType.YESTERDAY_WEATHER)) {
        ...
        private fun createSimpleHourlyForecastUiModel(
            ...
            val simpleHourlyForecast =
                hourlyForecastEntity.items.mapIndexed { i, it ->
        ...
        private fun createDetailHourlyForecastUiModel(
            ...
            val detailHourlyForecast =
                hourlyForecastEntity.items.groupBy {
        ...
        private fun createSimpleDailyForecastUiModel(dailyForecastEntity: DailyForecastEntity) =
