...
internal fun DrawScope.drawBaseLines(
    pointInfo: PointInfo,
    timeInfo: TimeInfo,
...
internal fun DrawScope.drawTextAndImage(
    ...
    pointInfo.run {
        ...
        drawText(
                ...
                textMeasurer.measure(
                    text =
                        createAnnotatedString(
                            timeInfo.timeHeaders[0].title,
                            timeInfo.timeHeaders[0].content,
                        ),
            ...
            topLeft = Offset(firstVerticalDividerX - xAmount, verticalDividerTop - yAmount),
            color = Color.White,
        )
        ...
        drawText(
            textLayoutResult =
                textMeasurer.measure(
                    text =
                        createAnnotatedString(
                            timeInfo.timeHeaders[1].title,
                            timeInfo.timeHeaders[1].content,
                        ),
                    style = TextStyle(fontSize = 12.sp, textAlign = TextAlign.Center),
                ).apply {
                    xAmount = size.width / 2f
            ...
            topLeft = Offset(secondVerticalDividerX - xAmount, verticalDividerTop - yAmount),
            color = Color.White,
        )
        ...
        drawText(
            textLayoutResult =
                textMeasurer.measure(
                    text =
                        createAnnotatedString(
                            timeInfo.timeHeaders[2].title,
                            timeInfo.timeHeaders[2].content,
                        ),
                    style = TextStyle(fontSize = 12.sp, textAlign = TextAlign.Center),
                ).apply {
                    xAmount = size.width / 2f
            ...
            topLeft = Offset(thirdVerticalDividerX - xAmount, verticalDividerTop - yAmount),
            color = Color.White,
        )
    }
}
