...
@HiltWorker
class OngoingNotificationCoroutineService
    @AssistedInject
    constructor(
        ...
        override suspend fun doWork(
            context: Context,
            argument: OngoingNotificationServiceArgument,
        ): Result {
        ...
        private suspend fun start(
            ...
            if (notificationEntity.location.locationType is LocationType.CurrentLocation &&
                !checkFeatureStateAndNotify(
                    arrayOf(
                        FeatureType
                            .Permission.Location,
            ...
            val notificationState =
                if (uiState.isSuccessful) {
                    ...
                    NotificationViewState(
                        ...
                        icon =
                            NotificationIconGenerator.createIcon(
                                context,
        ...
        private fun checkFeatureStateAndNotify(
